export default function TermsContent() {
  return (
    <div style={{ padding: "0", backgroundColor: "transparent", fontFamily: "var(--font-sans)", borderRadius: "16px" }}>
      <h2 style={{ fontSize: "28px", fontWeight: 700, color: "var(--ink)", marginBottom: "8px" }}>
        Chính sách sử dụng
      </h2>
      <p style={{ fontSize: "14px", color: "var(--ink)", opacity: 0.7, marginBottom: "32px" }}>
        Vui lòng đọc kỹ trước khi sử dụng website.
      </p>

      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        {/* Item 1 */}
        <div style={{ backgroundColor: "rgba(220, 38, 38, 0.05)", border: "1px solid rgba(220, 38, 38, 0.2)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
            ...
            <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#dc2626", margin: 0 }}>Hành vi xâm nhập & crawl dữ liệu</h3>
          </div>
        ...
        {/* Item 2 */}
        <div style={{ backgroundColor: "rgba(217, 119, 6, 0.05)", border: "1px solid rgba(217, 119, 6, 0.2)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
            ...
            <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#d97706", margin: 0 }}>Tài liệu phục vụ học tập cá nhân</h3>
          </div>
          <p style={{ fontSize: "14px", color: "var(--ink)", lineHeight: 1.6, margin: 0 }}>
        ...
        {/* Item 3 */}
        <div style={{ backgroundColor: "rgba(234, 88, 12, 0.05)", border: "1px solid rgba(234, 88, 12, 0.2)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
            ...
            <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#ea580c", margin: 0 }}>Cấm mua bán, phân phối lại</h3>
          </div>
          <p style={{ fontSize: "14px", color: "var(--ink)", lineHeight: 1.6, margin: 0 }}>
        ...
        {/* Item 4 */}
        <div style={{ backgroundColor: "var(--paper)", border: "1px solid var(--line)", borderRadius: "12px", padding: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
            ...
            <h3 style={{ fontSize: "18px", fontWeight: 700, color: "var(--ink)", margin: 0 }}>Chính sách xử lý vi phạm</h3>
          </div>
          <p style={{ fontSize: "14px", color: "var(--ink)", lineHeight: 1.6, margin: 0 }}>
      ...
      <div style={{ marginTop: "32px", textAlign: "center", fontSize: "13px", color: "var(--ink)", opacity: 0.6 }}>
